...
function createButton(container, key, label, allowSort, category) {
    ...
    // --- LONG PRESS LOGIC (Updated for Single Trigger) ---
    let pressTimer = null;
    ...
    const start = (e) => {
        ...
        // FIX: If timer is already running (e.g. from TouchStart), ignore MouseDown
        ...
        pressTimer = setTimeout(() => {
            ...
            openEditor(key);
            pressTimer = null; // Clear immediately after execution
        }, 600);
    };
    ...
    const move = (e) => {
        ...
        if (diffX > 10 || diffY > 10) {
            cancel(); // Use common cancel function
        }
    };
